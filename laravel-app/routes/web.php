...
Route::delete('/edit/project/{id}', [ProjectController::class, 'destroy'])->name('projects.destroy');
...
Route::resource('tasks', TaskController::class)->except(['create', 'edit', 'update', 'destroy']);
